...
- **pgrex01**: プライマリノード（192.168.76.101）
- **pgrex02**: スタンバイノード（192.168.76.102）

### ネットワーク構成
- **S-LAN (Service LAN)**: 192.168.76.0/24 - サービス LAN
- **D-LAN (Data LAN)**: 192.168.77.0/24 - Data Replication LAN
- **IC-LAN01**: 192.168.78.0/24 - IC LAN 1
- **IC-LAN02**: 192.168.79.0/24 - IC LAN 2
- **M-LAN (Management LAN)**: 192.168.80.0/24 - 管理用 LAN
